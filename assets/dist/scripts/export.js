...
jQuery(function ($) {
	...
	$('.export-file-container').hover(function () {
	...
	$('#pb-export-form').find('input').each(function () {
		...
		var val = __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.get('pb_' + name);
		var v = void 0;
		// Defaults
		if (typeof val === 'undefined') {
			// Defaults
			if (name === 'export_formats[pdf]' || name === 'export_formats[mpdf]' || name === 'export_formats[epub]' || name === 'export_formats[mobi]') {
		...
		__WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.set('pb_' + $(this).attr('name'), $(this).prop('checked'), {
			path: '/',
			expires: 365
		});
	});
...
module.exports = __webpack_require__("./assets/src/scripts/export.js");
